...
import type { CanvasNode, CanvasEdge, SecurityWarning, S3Config } from '@canvascloud/shared';
    ...
    for (const node of s3Nodes) {
      ...
      if (isPublicACL || isPublicBlockDisabled) {
        warnings.push({
          ...
          suggestion: 'Set bucket ACL to private and enable Block Public Access unless this bucket is hosting a public static website.',
        });
      }
    }
