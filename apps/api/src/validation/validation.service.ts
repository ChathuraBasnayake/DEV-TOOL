...
> = {
  ...
  rds: [
    { name: 'allocated_storage', label: 'Storage' },
    { name: 'engine', label: 'Engine' },
    { name: 'instance_class', label: 'Instance Class' },
  ],
  elasticache: [
    { name: 'cluster_id', label: 'Cluster ID' },
    { name: 'engine', label: 'Engine' },
    { name: 'node_type', label: 'Node Type' },
  ],
  dynamodb: [
    { name: 'name', label: 'Table Name' },
    { name: 'billing_mode', label: 'Billing Mode' },
    { name: 'hash_key', label: 'Hash Key' },
  ],
  s3: [{ name: 'bucket', label: 'Bucket Name' }],
  'iam-role': [
    { name: 'name', label: 'Name' },
    { name: 'assume_role_policy', label: 'Assume Role Policy' },
  ],
  'iam-policy': [
    { name: 'name', label: 'Name' },
    { name: 'policy_document', label: 'Policy Document' },
  ],
  lambda: [
  ...
  'api-gateway': [
    { name: 'name', label: 'Name' },
    { name: 'protocol_type', label: 'Protocol Type' },
  ],
