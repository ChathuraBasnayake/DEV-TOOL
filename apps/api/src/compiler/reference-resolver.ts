...
export const REF_MAP: Record<string, { field: string; ref: string }> = {
  ...
  'subnet->elasticache': {
    field: 'subnet_group',
    ref: 'aws_subnet.{source}.id',
  },
  'subnet->lambda': {
    field: 'vpc_config.subnet_ids',
    ref: 'aws_subnet.{source}.id',
  },
  ...
  'security-group->ec2': {
    ...
    ref: 'aws_security_group.{source}.id',
  },
  'security-group->rds': {
    field: 'vpc_security_group_ids',
    ref: 'aws_security_group.{source}.id',
  ...
  'route-table->subnet': {
    field: '__synthetic__',
    ref: 'aws_route_table_association',
  },
  ...
  'target-group->ec2': {
    field: '__synthetic__',
    ref: 'aws_lb_target_group_attachment',
  },
  'target-group->lambda': {
    field: '__synthetic__',
    ref: 'aws_lb_target_group_attachment',
  ...
  'launch-template->asg': {
    ...
    ref: 'aws_launch_template.{source}.id',
  },
  'asg->subnet': {
    field: 'vpc_zone_identifier',
    ref: 'aws_subnet.{target}.id',
  },
  'asg->target-group': {
    field: 'target_group_arns',
    ref: 'aws_lb_target_group.{target}.arn',
  },
  ...
  'iam-policy->iam-role': {
    field: '__synthetic__',
    ref: 'aws_iam_role_policy_attachment',
  },

  // Serverless
  'api-gateway->lambda': {
    field: '__synthetic__',
    ref: 'aws_apigatewayv2_integration',
  },
  ...
  'route53->cloudfront': {
    field: '__synthetic__',
    ref: 'aws_route53_record (alias)',
  },
  'cloudfront->s3': {
    field: 'origin.domain_name',
    ref: 'aws_s3_bucket.{target}.bucket_regional_domain_name',
  },
  'cloudfront->alb': {
    field: 'origin.domain_name',
    ref: 'aws_lb.{target}.dns_name',
  },
